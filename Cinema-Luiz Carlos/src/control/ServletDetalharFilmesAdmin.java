...
/**
 * Servlet implementation class ServletDetalharFilmesAdmin
 */
@WebServlet("/detalhaFilmeAdmin")
public class ServletDetalharFilmesAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletDetalharFilmesAdmin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//Obter conexao
				...
				//Dispachar o request
				RequestDispatcher rd = request.getRequestDispatcher("/detalharFilmeAdmin.jsp");
