...
/**
 * Servlet implementation class ServletListarPorCategoriaAdmin
 */
@WebServlet("/listarPorCategoriaAdmin")
public class ServletListarPorCategoriaAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletListarPorCategoriaAdmin() {
        super();
...
Connection conexao = new Conexao().getConexao();
		...
		//Dispachar o request
				RequestDispatcher rd = request.getRequestDispatcher("/listarPelaCategoriaAdmin.jsp");
