...
<% 	for (int i = 0; i < pessoaPersonagem.size(); i++){ 
		out.println("<tr><td>" + "<a href='/Cinema-Luiz_Carlos/detalhaFilme?idfilme="+ pessoaPersonagem.get(i).getIdfilme() +"'>" + pessoaPersonagem.get(i).getTitulo() +"</a></td><td> "+ pessoaPersonagem.get(i).getTipoPessoa() + "</td><td>" +pessoaPersonagem.get(i).getPersonagem() +"</td></tr>");}
 %>
</table>
</body>
</html>