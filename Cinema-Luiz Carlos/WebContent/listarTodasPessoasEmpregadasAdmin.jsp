...
<table border=1>
<tr><td>Todas as Pessoas</td><td>Ocupação</td></tr>
<% ArrayList<Pessoa> listarPessoas = (ArrayList<Pessoa>) request.getAttribute("listarPessoas"); %>

<% 	for (int i = 0; i < listarPessoas.size(); i++){ 
		out.println("<tr><td>" + "<a href='/Cinema-Luiz_Carlos/detalhaPessoaAdmin?idpessoa=" + listarPessoas.get(i).getIdpessoa() +"'>" +listarPessoas.get(i).getNomepessoa() +"</a></td>"+ "<td>"+ listarPessoas.get(i).getTipoPessoa() + "</td></tr>");}
 %>
</table>
 <hr>
